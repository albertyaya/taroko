...
require_once("sql_connect.php");
        ...
        // echo $id;
         ...
         {   if($sh_problem==''||$sh_name==''|| $sh_solution==''){}
              ...
              $sql="UPDATE fix set date1='$sh_date',shopname='$sh_name',problem='$sh_problem',solution='$sh_solution',remark='$sh_remark',engineer='$sh_engineer',contract='$sh_contract' where id='$id' ";
              ECHO "修改成功"; } 
        }
        else if($submit=='刪除')
        {
